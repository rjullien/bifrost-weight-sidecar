...
3. Calcul local des poids (urgence monthly, bloqueurs weekly/rolling bruts) — **sans**
...
Bifrost) n'est **jamais** réarmée par le filet de secours : elle échouerait. Si
moins de deux abonnements peuvent réellement servir, le contrôleur préfère
laisser le pool dégradé plutôt que leur envoyer du trafic voué à échouer.
